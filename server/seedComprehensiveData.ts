...
async function clearComprehensiveMockData() {
  ...
  try {
    ...
    await db.delete(addressVerifications).where(like(addressVerifications.verificationMethod, "MOCK_%"));
    ...
    await db.delete(cycleCountTasks).where(like(cycleCountTasks.cycleCountNumber, "MOCK_%"));
    await db.delete(inventoryAdjustments).where(like(inventoryAdjustments.adjustmentNumber, "MOCK_%"));
    
    await db.delete(putawayItems);
    await db.delete(putawayTasks).where(like(putawayTasks.cartId, "MOCK_%"));
    await db.delete(grnItems);
    await db.delete(goodsReceiptNotes).where(like(goodsReceiptNotes.grnNumber, "MOCK_%"));
    ...
    await db.delete(packTasks).where(like(packTasks.toteId, "MOCK_%"));
    await db.delete(pickTasks).where(like(pickTasks.toteId, "MOCK_%"));
    
    await db.delete(orderItems).where(like(orderItems.sku, "MOCK_%"));
    ...
    await db.delete(toteCartTypes).where(like(toteCartTypes.typeName, "MOCK_%"));
    await db.delete(staffRoles).where(like(staffRoles.roleName, "MOCK_%"));
