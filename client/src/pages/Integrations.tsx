...
const integrationConfigs = {
  ecommerce: [
    { name: "shopify", title: "Shopify", description: "Connect your Shopify store" },
    { name: "salla", title: "Salla", description: "Saudi e-commerce platform" },
    { name: "zid", title: "Zid", description: "MENA region e-commerce" },
    { name: "woocommerce", title: "WooCommerce", description: "WordPress e-commerce" },
    { name: "amazon", title: "Amazon", description: "Amazon marketplace" },
  ],
  courier: [
    { name: "aramex", title: "Aramex", description: "Regional shipping partner" },
    { name: "fastlo", title: "Fastlo", description: "Local delivery service" },
    { name: "naqel", title: "Naqel", description: "Saudi postal service" },
    { name: "smsa", title: "SMSA", description: "Express delivery" },
  ],
  messaging: [
    { name: "twilio_whatsapp", title: "Twilio WhatsApp", description: "WhatsApp messaging" },
    { name: "infobip", title: "Infobip", description: "Multi-channel messaging" },
    { name: "zenvia", title: "Zenvia", description: "Customer engagement" },
  ],
  payments: [
    { name: "tabby", title: "Tabby", description: "Buy now, pay later" },
    { name: "tamara", title: "Tamara", description: "Flexible payments" },
    { name: "mada", title: "MADA", description: "Saudi payment network" },
  ],
  erp: [
    { name: "sap", title: "SAP", description: "Enterprise resource planning" },
    { name: "ms_dynamics", title: "MS Dynamics", description: "Microsoft business apps" },
    { name: "zoho", title: "Zoho", description: "Business software suite" },
  ],
  analytics: [
    { name: "ga4", title: "Google Analytics 4", description: "Web analytics" },
    { name: "mixpanel", title: "Mixpanel", description: "Product analytics" },
    { name: "powerbi", title: "Power BI", description: "Business intelligence" },
  ]
};
